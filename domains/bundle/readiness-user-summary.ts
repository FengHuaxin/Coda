  ...
  switch (code) {
    ...
    case 'proposal':
      return {
        ...
        command: `coda bundle factory-init ${bundleName} --file <plan.json> --confirmed-proposal`,
      };
    case 'preference':
      return {
    ...
    case 'workflow':
      return {
        ...
        command: 'Ask /coda-any to revise the Workflow Nodes, Skill Bindings, or Output Schemas',
      };
    case 'control-plane':
      return {
    ...
    case 'benchmark':
      return {
        ...
        command: 'coda eval <generated-skill>/coda/eval.yaml --quick --html',
      };
    case 'review':
      return {
