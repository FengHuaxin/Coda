  ...
  return {
    ...
    userMessage: hasInvalidPreferences
      ? {
          ...
          summary: `Saved project preferences in .Coda/skill-preferences.yaml are invalid: ${preferencesResult.error}`,
          nextStep: 'Open .Coda/skill-preferences.yaml, fix the error, then run /coda-any again.',
        }
      : hasResumable
        ? {
