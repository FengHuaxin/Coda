...
const DEFAULT_REPORT_RELATIVE = '.coda/verify-result.md';
 ...
 *     falling back to `.coda/verify-result.md`.
 ...
 * so callers can fall back to a safe default. A malicious `.coda.yaml` must
