  ...
  return (
    ...
    >
      <div className="flex items-start gap-2 px-2 py-1">
        <img src="/favicon.png" alt="Coda" className="size-7 rounded-[7px]" />
        <div className="min-w-0">
          <div className="truncate text-base font-bold leading-tight">Coda Dashboard</div>
...
function ArtifactList({ change, onPreview }) {
  ...
  const CodaArtifacts = grouped.filter((a) => a.source === 'Coda');
