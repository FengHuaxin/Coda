/**
 * Guard tests — split from coda-scripts.test.ts for maintainability.
 *
 * Tests coda-guard.mjs phase guards: open guard (design.md skip for preset),
...
describe('coda guard', () => {
  ...
  beforeEach(async () => {
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), 'coda-guard-'));
