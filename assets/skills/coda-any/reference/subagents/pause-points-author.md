...
Pause points must fit the current workflow protocol, not merely list original Coda pause points.
...
- Pause points fit the current composed Skill instead of copying original Coda pause points.
