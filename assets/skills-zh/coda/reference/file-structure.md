...
规范路径：`Coda/reference/file-structure.md`

本文件是 Coda 项目文件结构参考。按需查阅，不随 skill 一次性加载。
...
.Coda/
└── config.yaml                        # Coda 项目配置（context_compression 默认 off，可设 beta）
```
