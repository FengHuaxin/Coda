...
export interface Platform {
  ...
  /** Hook configuration format. Determines how installCodaHooksForPlatform writes the hook config. */
...
export const PLATFORMS: Platform[] = [
  ...
  },
  {
    ...
    // Trae CN uses the same OpenSpec tool id as Trae (OpenSpec does not have a separate trae-cn tool)
    openspecToolId: 'trae',
    rulesDir: 'rules',
    rulesFormat: 'md',
  },
