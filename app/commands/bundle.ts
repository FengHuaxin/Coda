...
function formatStateEval(
  ...
  if (!evalState)
    return 'Benchmark: missing; run coda bundle benchmark-plan and coda bundle benchmark-record';
...
function formatStateReview(
  ...
  if (!reviewState) return 'Review: missing; run coda bundle review-summary before approval';
...
function formatStatusText(
  ...
  const factoryPackage =
    ...
    'missing; run coda bundle factory-generate or inspect factory-init plan';
