...
const TRANSLATIONS: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    setupComplete: 'Coda setup complete!',
    installed: 'Installed:',
    ...
    getStartedCoda: '/Coda "your idea"  — Start a new change with full workflow',
    getStartedHotfix: '/Coda-hotfix       — Quick bug fix (skip brainstorming)',
    getStartedTweak: '/Coda-tweak        — Small change (skip brainstorming and plan)',
    ...
    noInstallsFound: 'No platforms with Coda skills installed. Run `Coda init` first.',
    updatingSkillsOnTargets: 'Updating Coda skills on',
    ...
    configMerged:
      'Project config merged (.Coda/config.yaml): preserved your values, added any missing fields',
    cancelled: 'Cancelled.',
  ...
  zh: {
    ...
    getStarted: '开始使用：',
    getStartedCoda: '/Coda "你的想法"  — 启动完整工作流',
    getStartedHotfix: '/Coda-hotfix       — 快速修复（跳过 brainstorming）',
    getStartedTweak: '/Coda-tweak        — 小改动（跳过 brainstorming 和完整 plan）',
    ...
    noInstallsFound: '未检测到已安装 Coda skills 的平台。请先运行 `Coda init`。',
    updatingSkillsOnTargets: '正在更新 Coda skills，覆盖',
    ...
    summaryLanguage: '语言：',
    updateComplete: '更新完成。',
    configMerged: '项目配置已合并 (.Coda/config.yaml)：已保留你的设置，补齐缺失字段',
    cancelled: '已取消。',
    installMode: '安装模式：',
